...
@section('content')
	<div class="grid-form1">
		<div class="panel-body">
			<h2 id="h2.-bootstrap-heading">轮播图添加<a class="anchorjs-link" href="#h2.-bootstrap-heading"><span class="anchorjs-icon"></span></a></h2>
	<!-- 消息提示开始 -->
	@if(session('error'))
     ...
     @endif
	<!-- 消息提示结束 -->
			<form role="form" class="form-horizontal" action="/admin/turnimage/store" method="post" enctype="multipart/form-data">
				{{csrf_field()}}
				<div class="form-group ">
					<label class="col-md-2 control-label">轮播图标题:</label>
					<div class="col-md-8">
						<div class="input-group">
							<input type="text" name="title" class="form-control1" placeholder="请轮播图标题...">
						</div>
					</div>
				</div>
