	...
	<div class="grid-form1">
		<div class="panel-body">
			<h2 id="h2.-bootstrap-heading">广告添加<a class="anchorjs-link" href="#h2.-bootstrap-heading"><span class="anchorjs-icon"></span></a></h2>
					...
					@endif
			<form role="form" class="form-horizontal" action="/admin/adverts/store" method="post" enctype="multipart/form-data">
				{{csrf_field()}}
				...
				<div class="form-group">
					...
					<div class="col-md-8">
						<div class="input-group">
							<input type="file" class="form-control1" placeholder="SRC" name="pic">
							<img width="120" src="">
						</div>
					</div>
				</div>
				 <p style="font-size:20px;color:red;float:right;">Tips:图片大小请控制在350x250左右</p>
