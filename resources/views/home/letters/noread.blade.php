            ...
            <div class="content" style="min-height: 800px;">
                ...
                <div class="container">
                  <ul class="layui-nav layui-bg-blue" style="" lay-filter="demo">
                    ...
                    <li class="layui-nav-item layui-this"><a href="/letters/noread">未读信件</a></li>\
                  ...
                  @foreach($data as $k => $v)
                    ...
                    <div class="row" style="padding-left:5px;padding-top:10px;color:#999;">
                      ...
                      <div class="col-md-3" style="color:#999;">发信人：{{ $v -> users -> username }}</div>
                  ...
                  @endforeach
                  @else
                    <h2 style="color:#FF5722;font-size:20px;">你还没有收到信哦！</h2>
                  @endif
