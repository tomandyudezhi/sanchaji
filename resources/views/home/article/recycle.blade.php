            ...
            <div class="content" style="min-height: 800px;">
                ...
                <div class="container">
                  <ul class="layui-nav layui-bg-blue" style="" lay-filter="demo">
                    ...
                    <li class="layui-nav-item layui-this"><a href="/article/recycle">回收站</a></li>
                  </ul>
                  <form action="/article/recycle" class="form-inline text-right" style="margin-top: 5px;">
                  ...
                  @foreach($data as $k => $v)
                    ...
                    <div class="row" style="padding-left:5px;padding-top:10px;color:#999;">
                      ...
                      <div class="col-md-6 text-right" >
                        <a href="javascript:;" value="{{$v->id}}" class="layui-btn layui-btn-xs huifu">恢复</a>
...
<script>
  ...
  $('.layui-btn-danger').click(function(){
    ...
    var ele = $(this);
    layer.confirm('文章将被彻底删除',function(index){
        $.get('/article/delever/'+id,function(msg){
          if(msg == 'error'){
            layer.msg('删除失败');
          }else{
            layer.msg('删除成功');
  ...
  $('.huifu').click(function(){
    var id = $(this).attr('value');
    var ele = $(this);
    layer.confirm('文章将恢复',function(index){
        $.get('/article/recover/'+id,function(msg){
          if(msg == 'error'){
            layer.msg('恢复失败');
          }else{
            layer.msg('恢复成功');
